        ...
        actions: [
          IconButton(
              ...
              icon: const Icon(Icons
                  .refresh) // you can also work with GestureDetector() or InkWell()
              ),
        ],
      ),
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          final currentTemp = (currentWeatherData['main']['temp']) -
              273.15; // finalize the temperature in the display
          final currentSky = currentWeatherData['weather'][0]
              ['main']; // finalize the sky type in the display
                ...
                SizedBox(
                  ...
                  child: Card(
                    ...
                    color: const Color.fromARGB(
                        255, 44, 41, 50), // changing the background color
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(
                          16), // apply this to visible the elevation or to remove the whole blurry bg
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    scrollDirection: Axis
                        .horizontal, // to change the direction of the scroll, but still height issue because the time goes to next line; let's keep it in 1 line
                    itemBuilder: (context, index) {
                      ...
                      final hourlyTemp =
                          (hourlyForecast['main']['temp'] - 273.15)
                              .toStringAsFixed(2);
                      final hourlySky =
                          theData['list'][index + 1]['weather'][0]['main'];
                      ...
                      return HourlyForecastItem(
                        time: DateFormat.j().format(
                            time), // instead of "DateFormat.j()", you can use "DateFormat('j')"
